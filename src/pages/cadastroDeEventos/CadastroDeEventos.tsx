import { Flex, Box, FormControl, Input, FormLabel, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper, Button, useFocusEffect } from '@chakra-ui/react'
...
useEffect(() => {
  ...
  const criarCurso = (event: any) => {
    ...
    try {
        createCurso(curso).then((curso) =>
        console.log("Evento Criado", curso)
        )
            ...
            <Box boxShadow='base' bg='white' w='75%' border='4px solid' borderColor='blackAlpha.100' rounded='md' shadow='dark-lg' >
                <Flex w='100%' h='65vh' flexDir='column'>
                    ...
                    <FormControl w='40%' isRequired>
                        ...
                        <Input type='text' {...register("nomeCurso", {required: true})} onChange={(event) =>{
                            setCurso({
                                ...curso,
                    ...
                    <FormControl w='30%' isRequired>
                        ...
                        <Select placeholder='Palestrante Disponível' isMulti closeMenuOnSelect={false} options={nomePalestrantes} {
                    ...
                    <FormControl w='30%' isRequired>
                        ...
                        <Input type='datetime-local' {...register("dataCurso")} 
                        onChange={(event) => {
                            const { target } = event
                    ...
                    <FormControl w='20%' isRequired>
                        ...
                        <Input type='datetime-local' {...register("tempoInicio")} 
                        onChange={(event) => {
                            const { target } = event
                            console.log(target.value);
                            const dataConvertida = converterData(event.target.value);
                    ...
                    <FormControl w='20%' isRequired>
                        ...
                        <Input type='datetime-local' {...register("tempoFinalizacao")} 
                        onChange={(event) => {
                            const { target } = event
                            console.log(target.value);
                            const dataConvertida = converterData(event.target.value);
                    ...
                    <FormControl w='25%'>
                        ...
                        <Input type='text' {...register("observacao")} onChange={(event) => {
                            setCurso({
                                ...curso,
                    ...
                    <FormLabel>Participantes</FormLabel>
                            ...
                            <Input type='number' {...register("participante", {required: true})} onChange={(event) => {
                                setCurso({
                                    ...curso,
                    ...
                    <FormControl w='15%'>
                        <FormLabel>Arrecadação</FormLabel>
                            ...
                            <Input {...register("arrecadacao", {required: true})} onChange={(event) => {
                                setCurso({
                                    ...curso,
                    ...
                    <FormControl w='40%' isRequired>
                        ...
                        <Input type='text' {...register("descricaoCurso")} onChange={(event) => {
                            setCurso({
                                ...curso,
